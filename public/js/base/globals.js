...
class Variables {
  ...
  _initVariables() {
    ...
    Globals.successrgb = rootStyle.getPropertyValue('--success-rgb').trim();
    Globals.dangerrgb = rootStyle.getPropertyValue('--danger-rgb').trim();
    Globals.warningrgb = rootStyle.getPropertyValue('--warning-rgb').trim();
