        ...
        <div class="position-relative h-100 d-flex flex-column justify-content-center px-5 py-5" style="z-index: 2;">
            <div class="login-hero-brand mb-5">
                <div class="d-inline-flex align-items-center gap-2 px-3 py-2 rounded-pill login-hero-pill">
                    <i data-acorn-icon="key" data-acorn-size="16"></i>
                ...
                <h1 class="text-white fw-bold mt-4 mb-2" style="font-size: 2.25rem; line-height: 1.15;">
                    Lupa Password<br/>Anda?
                </h1>
                <p class="text-white mb-0" style="opacity: 0.85; max-width: 480px;">
                    Jangan khawatir. Masukkan email yang terdaftar dan kami akan mengirim tautan untuk mengatur ulang password Anda.
                </p>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-12 col-sm-6">
                        <div class="login-stat-card d-flex align-items-start gap-3">
                            <span class="login-stat-icon flex-shrink-0"><i data-acorn-icon="email" data-acorn-size="18"></i></span>
                            <div>
                                <div class="text-white fw-bold mb-1" style="font-size: 0.95rem;">1. Kirim Email</div>
                                <div class="login-stat-label" style="font-size: 0.72rem; text-transform: none; letter-spacing: 0;">Masukkan email akun Anda yang terdaftar.</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="login-stat-card d-flex align-items-start gap-3">
                            ...
                            <div>
                                <div class="text-white fw-bold mb-1" style="font-size: 0.95rem;">2. Cek Inbox</div>
                                <div class="login-stat-label" style="font-size: 0.72rem; text-transform: none; letter-spacing: 0;">Buka tautan reset yang kami kirim ke email.</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="login-stat-card d-flex align-items-start gap-3">
                            <span class="login-stat-icon flex-shrink-0"><i data-acorn-icon="lock-on" data-acorn-size="18"></i></span>
                            <div>
                                <div class="text-white fw-bold mb-1" style="font-size: 0.95rem;">3. Buat Password Baru</div>
                                <div class="login-stat-label" style="font-size: 0.72rem; text-transform: none; letter-spacing: 0;">Tentukan password baru yang aman dan mudah diingat.</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="login-stat-card d-flex align-items-start gap-3">
                            ...
                            <div>
                                <div class="text-white fw-bold mb-1" style="font-size: 0.95rem;">4. Akun Aman</div>
                                <div class="login-stat-label" style="font-size: 0.72rem; text-transform: none; letter-spacing: 0;">Masuk kembali dengan password baru Anda.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="register-card-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}" novalidate>
                        ...
                        <button type="submit" class="btn btn-lg w-100 login-submit mt-2">
                            <i data-acorn-icon="send" data-acorn-size="18" class="me-2 align-middle"></i>
                            Kirim Tautan Reset
                        </button>
                    </form>
                </div>
