        ...
        <div class="position-relative h-100 d-flex flex-column justify-content-center px-5 py-5" style="z-index: 2;">
            <div class="login-hero-brand mb-5">
                <div class="d-inline-flex align-items-center gap-2 px-3 py-2 rounded-pill login-hero-pill">
                    <i data-acorn-icon="lock-on" data-acorn-size="16"></i>
                ...
                <p class="text-white mb-0" style="opacity: 0.85; max-width: 480px;">
                    Pilih password baru yang kuat dan unik untuk menjaga keamanan akun Anda. Pastikan Anda mengingatnya dengan baik.
                </p>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-12 col-sm-6">
                        <div class="login-stat-card d-flex align-items-start gap-3">
                            ...
                            <div>
                                <div class="text-white fw-bold mb-1" style="font-size: 0.95rem;">Minimal 8 Karakter</div>
                                <div class="login-stat-label" style="font-size: 0.72rem; text-transform: none; letter-spacing: 0;">Semakin panjang, semakin aman.</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="login-stat-card d-flex align-items-start gap-3">
                            <span class="login-stat-icon flex-shrink-0"><i data-acorn-icon="settings" data-acorn-size="18"></i></span>
                            <div>
                                <div class="text-white fw-bold mb-1" style="font-size: 0.95rem;">Kombinasi Beragam</div>
                                <div class="login-stat-label" style="font-size: 0.72rem; text-transform: none; letter-spacing: 0;">Huruf besar, kecil, angka, dan simbol.</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="login-stat-card d-flex align-items-start gap-3">
                            <span class="login-stat-icon flex-shrink-0"><i data-acorn-icon="close-circle" data-acorn-size="18"></i></span>
                            <div>
                                <div class="text-white fw-bold mb-1" style="font-size: 0.95rem;">Hindari Data Pribadi</div>
                                <div class="login-stat-label" style="font-size: 0.72rem; text-transform: none; letter-spacing: 0;">Jangan pakai nama, tanggal lahir, atau NIK.</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <div class="login-stat-card d-flex align-items-start gap-3">
                            ...
                            <div>
                                <div class="text-white fw-bold mb-1" style="font-size: 0.95rem;">Rahasiakan</div>
                                <div class="login-stat-label" style="font-size: 0.72rem; text-transform: none; letter-spacing: 0;">Jangan bagikan ke siapa pun.</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="register-card-wrapper">
            <div class="register-card">
                ...
                <div class="mb-2 text-center px-3">
                    <h5 class="fw-bold mb-1" style="color: #0f172a;">Reset Password</h5>
                ...
                <div class="register-card-body">
                    <form method="POST" action="{{ route('password.update') }}" novalidate>
                        ...
                        <div class="mb-3 login-field">
                            <label for="password" class="login-field-label">Password Baru</label>
                            <div class="position-relative">
                        ...
                        <div class="mb-3 login-field">
                            <label for="password-confirm" class="login-field-label">Konfirmasi Password Baru</label>
                            <div class="position-relative">
                        ...
                        <button type="submit" class="btn btn-lg w-100 login-submit mt-2">
                            <i data-acorn-icon="check-circle" data-acorn-size="18" class="me-2 align-middle"></i>
