                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_user') is-invalid @enderror" name="nama_user" required
                                   value="{{ old('nama_user', $userDetail?->nama_user ?? auth()->user()->nama ?? '') }}"/>
                            @error('nama_user')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" maxlength="20"
                                   value="{{ old('phone', $userDetail?->phone ?? auth()->user()->no_telp ?? '') }}"/>
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" rows="2">{{ old('alamat', $userDetail?->alamat ?? '') }}</textarea>
                            @error('alamat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_personal') is-invalid @enderror" name="nama_personal" id="nama_personal"
                                   value="{{ old('nama_personal', $userDetail?->nama_personal ?? '') }}"/>
                            @error('nama_personal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" maxlength="16"
                                   value="{{ old('nik', $userDetail?->nik ?? '') }}"/>
                            @error('nik')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                            <label class="form-label text-small text-uppercase">Upload KTP <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_lembaga') is-invalid @enderror" name="nama_lembaga" id="nama_lembaga"
                                   value="{{ old('nama_lembaga', $userDetail?->nama_lembaga ?? '') }}"/>
                            @error('nama_lembaga')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                            <label class="form-label text-small text-uppercase">Upload Surat Kuasa <span class="text-danger">*</span></label>
