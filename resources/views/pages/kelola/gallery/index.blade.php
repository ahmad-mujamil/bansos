...
@section('content')
    <div class="col">
        <div class="page-title-container mb-3">
            <div class="row">
                <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4">Kelola Galeri</h1>
                ...
                <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                    <a href="{{ route('kelola.gallery.create') }}" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto">
                ...
                <div class="row">
                    <div class="col-12 col-sm-5 col-lg-3 col-xxl-2 mb-3">
                        <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 border border-separator bg-foreground search-sm">
                            <input class="form-control form-control-sm datatable-search" placeholder="Search" data-datatable="#datatable-gallery"/>
                            <span class="search-magnifier-icon"><i data-acorn-icon="search"></i></span>
                            <span class="search-delete-icon d-none"><i data-acorn-icon="close"></i></span>
                        </div>
                    </div>
                </div>
                <table class="data-table data-table-pagination data-table-standard responsive nowrap stripe" id="datatable-gallery">
                    <thead>
                        <tr>
                            ...
                            <th class="text-muted text-small text-uppercase">Tampil</th>
...
@push('js_vendor')
    ...
    <script>
        ...
        $('#datatable-gallery').DataTable({
            ...
            ajax: "{!! route('kelola.gallery.index') !!}",
            columns: [
