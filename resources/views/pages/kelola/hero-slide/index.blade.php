...
@section('content')
    <div class="col">
        <div class="page-title-container mb-3">
            <div class="row">
                <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Kelola Slider</h1>
                ...
                <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                    <a href="{{ route('kelola.slider.create') }}" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto">
        ...
        <div class="card mb-5">
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-5 col-lg-3 col-xxl-2 mb-3">
                        <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 border border-separator bg-foreground search-sm">
                            <input class="form-control form-control-sm datatable-search" placeholder="Search" data-datatable="#datatable-slider"/>
                    ...
                    <div class="col-12 col-sm-7 col-lg-9 col-xxl-10 text-end mb-3">
                        <div class="d-inline-block">
                            <button class="btn btn-icon btn-icon-only btn-outline-muted btn-sm datatable-print" type="button" data-datatable="#datatable-slider">
                                <i data-acorn-icon="print"></i>
                            </button>
                            <div class="d-inline-block datatable-export" data-datatable="#datatable-slider">
                ...
                <table class="data-table data-table-pagination data-table-standard responsive nowrap stripe" id="datatable-slider">
                    <thead>
                    <tr>
...
@push('js_vendor')
    ...
    <script>
        ...
        $('#datatable-slider').DataTable({
            ...
            ajax: "{!! route('kelola.slider.index') !!}",
            columns: [
                {data: 'gambar', name: 'gambar', orderable: false, searchable: false},
                {data: 'kategori', name: 'kategori'},
                {data: 'judul', name: 'judul'},
                {data: 'urutan', name: 'urutan'},
                {data: 'aktif', name: 'is_active', orderable: false, searchable: false},
