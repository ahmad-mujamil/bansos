...
@section('content')
    <div class="col">
        <div class="page-title-container mb-3">
            <div class="row">
                <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Kelola Berita</h1>
                ...
                <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                    <a href="{{ route('kelola.berita.create') }}" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto">
            ...
            <div class="card-body">
                ...
                <table class="data-table data-table-pagination data-table-standard responsive nowrap stripe" id="datatable-serverside">
                    ...
                    <tr>
                        ...
                        <th class="text-muted text-small text-uppercase">Terbit</th>
...
@push('js_vendor')
    ...
    <script>
        ...
        $('#datatable-serverside').DataTable({
            ...
            ajax: "{!! route('kelola.berita.index') !!}",
            columns: [
                {data: 'gambar', name: 'gambar', orderable: false, searchable: false},
                {data: 'kategori', name: 'kategori_berita.nama'},
