...
class UserSystemInfoHelper
{
    ...
    public static function get_encrypted_desc()
    {
        ...
        return base64_encode($ip.";".$device.";".$os.";".$browser);
    }

    public static function get_device_desc()
    {
    ...
    public static function is_same_device_id($user)
    {
        ...
        $currentDeviceId = $ip.";".$device.";".$os.";".$browser;
        return $currentDeviceId===$user->device_id;
    }
}
