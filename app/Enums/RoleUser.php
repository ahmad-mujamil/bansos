    ...
    public function getPermissions(): array
    {
        return match ($this) {
            ...
            self::ADMIN => [
                ...
                'DATA_KELOMPOK_MASYARAKAT','JENIS_KELOMPOK_MASYARAKAT',
                'MASTER_DATA', 'PENDUDUK', 'JENIS_BANTUAN', 'TAHUN_ANGGARAN', 'OPD','PENGGUNA',
                ...
                "MONITORING_DAN_REALISASI",'MONITORING','CARI_PENDUDUK_NIK'
            ],
            self::OPD => [
                'SIDE_MASTER_DATA', 'KELOMPOK_MASYARAKAT','PENDUDUK',
                'SIDE_VERIFIKASI', 'VERIFY_PENGAJUAN', 'VERIFY_PENGGUNA', 'PENGAJUAN_OPD',
                'SIDE_LAPORAN', 'SIDE_LAP_PENGAJUAN', 'SIDE_LAP_ANGGOTA_KELOMPOK', 'SIDE_LAP_KELOMPOK', 'LAP_PENERIMA_BANTUAN',
                "MONITORING_DAN_REALISASI",'MONITORING','CARI_PENDUDUK_NIK',
